...
namespace BluetoothLEExplorer.Views
{
        ...
        global::Windows.UI.Xaml.Markup.IComponentConnector2
    {
            ...
            IVirtualKeyboardPage_Bindings
        {
            ...
            private void Invoke_ViewModel_IsSettingUp_M_Equals_2609910045(int phase)
            {
            ...
            private void Update_ViewModel_IsSettingUp(global::System.Boolean obj, int phase)
            {
                if ((phase & (NOT_PHASED | DATA_CHANGED | (1 << 0))) != 0)
                {
                    this.Update_ViewModel_IsSettingUp_M_Equals_2609910045(phase);
                }
                if ((phase & ((1 << 0) | NOT_PHASED | DATA_CHANGED)) != 0)
                {
            ...
            private void Update_ViewModel_IsSettingUp_M_Equals_2609910045(int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED | DATA_CHANGED)) != 0)
                {
                    this.PendingFunctionBindings["ViewModel_IsSettingUp_M_Equals_2609910045"] = new InvokeFunctionDelegate(this.Invoke_ViewModel_IsSettingUp_M_Equals_2609910045); 
                }
            }
