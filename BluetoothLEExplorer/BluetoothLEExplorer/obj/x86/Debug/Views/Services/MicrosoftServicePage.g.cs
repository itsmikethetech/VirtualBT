...
namespace BluetoothLEExplorer.Views
{
        ...
        global::Windows.UI.Xaml.Markup.IComponentConnector2
    {
            ...
            IMicrosoftServicePage_Bindings
        {
            ...
            private static bool isobj21IsOnDisabled = false;
            ...
            {
                if (lineNumber == 159 && columnNumber == 76)
                {
                    isobj12CharacteristicDisabled = true;
                }
                else if (lineNumber == 161 && columnNumber == 76)
                {
                    isobj13CharacteristicDisabled = true;
                }
                else if (lineNumber == 162 && columnNumber == 76)
                {
                    isobj14CharacteristicDisabled = true;
                }
                else if (lineNumber == 163 && columnNumber == 76)
                {
                    isobj15CharacteristicDisabled = true;
                }
                else if (lineNumber == 164 && columnNumber == 76)
                {
                ...
                else if (lineNumber == 146 && columnNumber == 17)
                {
                    isobj20IsOnDisabled = true;
                }
                else if (lineNumber == 150 && columnNumber == 31)
                {
                    isobj21IsOnDisabled = true;
                }
            ...
            public void Connect(int connectionId, global::System.Object target)
            {
                switch(connectionId)
                {
                    ...
                    case 22: // Views\Services\MicrosoftServicePage.xaml line 129
                        ...
                        break;
                    case 23: // Views\Services\MicrosoftServicePage.xaml line 130
                        ...
                        break;
                    case 24: // Views\Services\MicrosoftServicePage.xaml line 131
            ...
            private void Update_ViewModel_ReadCharacteristic(global::BluetoothLEExplorer.ViewModels.GenericGattCharacteristicViewModel obj, int phase)
            {
                ...
                {
                    // Views\Services\MicrosoftServicePage.xaml line 159
            ...
            private void Update_ViewModel_WriteCharacteristic(global::BluetoothLEExplorer.ViewModels.GenericGattCharacteristicViewModel obj, int phase)
            {
                ...
                if ((phase & ((1 << 0) | NOT_PHASED | DATA_CHANGED)) != 0)
                {
                    // Views\Services\MicrosoftServicePage.xaml line 161
            ...
            private void Update_ViewModel_NotifyCharacteristic(global::BluetoothLEExplorer.ViewModels.GenericGattCharacteristicViewModel obj, int phase)
            {
                ...
                if ((phase & ((1 << 0) | NOT_PHASED | DATA_CHANGED)) != 0)
                {
                    // Views\Services\MicrosoftServicePage.xaml line 162
            ...
            private void Update_ViewModel_IndicateCharacteristic(global::BluetoothLEExplorer.ViewModels.GenericGattCharacteristicViewModel obj, int phase)
            {
                ...
                if ((phase & ((1 << 0) | NOT_PHASED | DATA_CHANGED)) != 0)
                {
                    // Views\Services\MicrosoftServicePage.xaml line 163
            ...
            private void Update_ViewModel_ReadLongCharacteristic(global::BluetoothLEExplorer.ViewModels.GenericGattCharacteristicViewModel obj, int phase)
            {
                ...
                if ((phase & ((1 << 0) | NOT_PHASED | DATA_CHANGED)) != 0)
                {
                    // Views\Services\MicrosoftServicePage.xaml line 164
            ...
            private void Update_ViewModel_ServiceVM(global::BluetoothLEExplorer.ViewModels.GenericGattServiceViewModel obj, int phase)
            {
                ...
                if (obj != null)
                {
                    if ((phase & (NOT_PHASED | DATA_CHANGED | (1 << 0))) != 0)
                    {
                        ...
                        this.Update_ViewModel_ServiceVM_IncludeServiceData(obj.IncludeServiceData, phase);
            ...
            private void Update_ViewModel_ServiceVM_IsDiscoverable(global::System.Boolean obj, int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED | DATA_CHANGED)) != 0)
                {
                    // Views\Services\MicrosoftServicePage.xaml line 140
            ...
            private void Update_ViewModel_ServiceVM_IncludeServiceData(global::System.Boolean obj, int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED | DATA_CHANGED)) != 0)
                {
                    // Views\Services\MicrosoftServicePage.xaml line 142
                ...
                if (this.initialized)
                {
                    if (this.dataRoot != null)
                    {
                        if (this.dataRoot.ViewModel != null)
                        {
                            ...
                            {
                                this.dataRoot.ViewModel.ServiceVM.IsConnectable = this.obj18.IsOn;
                            }
                        }
                    }
                }
                ...
                if (this.initialized)
                {
                    if (this.dataRoot != null)
                    {
                        if (this.dataRoot.ViewModel != null)
                        {
                            if (this.dataRoot.ViewModel.ServiceVM != null)
                            {
                                this.dataRoot.ViewModel.ServiceVM.IsDiscoverable = this.obj19.IsOn;
                            }
                        }
                    }
                }
                ...
                if (this.initialized)
                {
                    if (this.dataRoot != null)
                    {
                        if (this.dataRoot.ViewModel != null)
                        {
                            if (this.dataRoot.ViewModel.ServiceVM != null)
                            {
                                this.dataRoot.ViewModel.ServiceVM.IncludeServiceData = this.obj20.IsOn;
                            }
                        }
                    }
                }
            }
            private void UpdateTwoWay_21_IsOn()
            {
                if (this.initialized)
                {
                    if (this.dataRoot != null)
                    {
                        if (this.dataRoot.ViewModel != null)
                        {
                            if (this.dataRoot.ViewModel.ServiceVM != null)
                            {
                                this.dataRoot.ViewModel.ServiceVM.IsPublishing = this.obj21.IsOn;
                            }
                        }
                    }
                }
            ...
            private class MicrosoftServicePage_obj1_BindingsTracking
            {
                    ...
                    if (bindings != null)
                    {
                        ...
                        if (global::System.String.IsNullOrEmpty(propName))
                        {
                            if (obj != null)
                            {
                                ...
                                bindings.Update_ViewModel_ServiceVM_IncludeServiceData(obj.IncludeServiceData, DATA_CHANGED);
                ...
                public void RegisterTwoWayListener_19(global::Windows.UI.Xaml.Controls.ToggleSwitch sourceObject)
                {
                    sourceObject.RegisterPropertyChangedCallback(global::Windows.UI.Xaml.Controls.ToggleSwitch.IsOnProperty, (sender, prop) =>
                    {
                        var bindingObj = this.TryGetBindingObject();
                ...
                public void RegisterTwoWayListener_21(global::Windows.UI.Xaml.Controls.ToggleSwitch sourceObject)
                {
                    sourceObject.RegisterPropertyChangedCallback(global::Windows.UI.Xaml.Controls.ToggleSwitch.IsOnProperty, (sender, prop) =>
                    {
                        var bindingObj = this.TryGetBindingObject();
                        if (bindingObj != null)
                        {
                            bindingObj.UpdateTwoWay_21_IsOn();
                        }
                    });
                }
            }
        ...
        public void Connect(int connectionId, object target)
        {
            ...
            case 20: // Views\Services\MicrosoftServicePage.xaml line 142
                {
                    this.ServiceDataSwitch = (global::Windows.UI.Xaml.Controls.ToggleSwitch)(target);
                }
                break;
            case 21: // Views\Services\MicrosoftServicePage.xaml line 149
                {
